...
const Topbar = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "topbar", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "logo-wrapper", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("img", { className: "logo", src: "/src/assets/fabfarm_logo_cut.png", alt: "logo" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "logo-title", children: "FabFarm Algarve" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hamburger-container", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/settings", children: "Settings" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("img", { className: "hamburger", src: "/src/assets/icons/hamburger.svg", alt: "menu" })
    ] })
  ] });
};
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "dashboard", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "cards-container", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: currentDate }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "card-value", children: currentTime })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "icon-container", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "/src/assets/icons/thermometer.svg", alt: "thermometer" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "card-value", children: data.global.temperature ?? "n/a" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "icon-container", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "/src/assets/icons/thermometer.svg", alt: "humidity" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "card-value", children: data.global.humidity ?? "n/a" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card", children: [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "controls", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "controls-container", children: data.relays.map((relay) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "control-box", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "box-label", children: [
          relay.name,
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "pin-info", children: [
            "Pin ",
            relay.pin
          ] })
        ] }),
      ...
      !!relay.isScheduleMode && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "scheduling-wrapper", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "schedules-table-wrapper", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: relay.schedules.map((schedule, index2) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: index2 }),
...
const DateAndTime = ({ currentTime, inputDate, setInputDate, inputTime, setInputTime, setDateTime }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "settings-box", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("header", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Date and Time" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: currentTime }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "settings-container", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "date", children: "Date" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "date", id: "date", name: "date", value: inputDate, onChange: setInputDate })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "time", children: "Time" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "time", id: "time", name: "time", value: inputTime, onChange: setInputTime })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "set-date-time-btn", onClick: setDateTime, children: "Set time and date" })
    ] })
  ] });
};
const Relays$1 = "";
const Relays = ({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "settings-box", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("header", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Relays" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "settings-container", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: "Current relays" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { children: "Relay ID" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { children: "Relay name" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { children: "Relay pin" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { children: "Current status" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { children: "Action" })
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: relays.map((relay) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: relay.id }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: relay.name }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: relay.pin }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: relay.isEnabled ? "On" : "Off" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => removeRelay(relay.id), children: "Remove relay" }) })
          ] }, relay.id)) })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: "Add a relay" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "select",
            {
              ...
              children: [false, true].map((option, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: option, children: option ? "On" : "Off" }, i))
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "add-relay-btn", onClick: addrelay, children: "Add Relay" })
      ] })
    ] })
  ] });
};
const WifiCredentials$1 = "";
const WifiCredentials = ({ ssidInput, setSsidInput, passwordInput, setPasswordInput, updateCredentials }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "settings-box", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("header", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Wifi Credentials" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "ssid", children: "SSID" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            type: "text",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "set-wifi-credentials", onClick: updateCredentials, children: "Set WiFi Credentials" }) })
    ] })
  ] });
};
const FirmwareUpdate = ({ updateFirmware }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "settings-box", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("header", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Firmware Update" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: updateFirmware, children: "Update firmware" }) })
  ] });
};
const Settings = () => {
  const { data, setData } = useData();
  const navigate = useNavigate();
  const [inputDate, setInputDate] = reactExports.useState("");
  const [inputTime, setInputTime] = reactExports.useState("");
  const [relayNameInput, setRelayNameInput] = reactExports.useState("");
  const [relayPinInput, setRelayPinInput] = reactExports.useState("");
  const [relayStatusInput, setRelayStatusInput] = reactExports.useState("");
  const [ssidInput, setSsidInput] = reactExports.useState("");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("main", { children: !!data && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(FirmwareUpdate, { updateFirmware })
  ] }) });
};
const Update = () => {
...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "app-container", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Routes, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/update", element: /* @__PURE__ */ jsxRuntimeExports.jsx(Update, {}) })
    ] })
  ] });
}
